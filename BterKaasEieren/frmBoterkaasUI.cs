...
{
    public partial class frmBoterkaasUI : Form
    {
        ...
        Color defBack = Color.Gainsboro;

        public frmBoterkaasUI()
        {
            InitializeComponent();
        }
        ...
        private void KiesKleur(bool isSpeler1, Button button)
        {
            if (colorDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                if(isSpeler1 == false)
                {
                    ...
                    if(speler1Kleur == speler2Kleur)
                    {
                        MessageBox.Show("Dat is en ongeldige Kleur");
                    }
                    else { button.BackColor = speler2Kleur; }
        ...
        private void GelijkSpel()
        {
            ...
            btn1.BackColor = defBack;
            btn2.BackColor = defBack;
            btn3.BackColor = defBack;
            btn4.BackColor = defBack;
            btn5.BackColor = defBack;
            btn6.BackColor = defBack;
            btn7.BackColor = defBack;
            btn8.BackColor = defBack;
            btn9.BackColor = defBack;
